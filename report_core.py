...
<div class="card" style="padding:24px;">
  ...
  <div style="font-size:11px; color:#475569; margin-bottom:14px; line-height:1.7; font-weight:500;">
    각 행 읽는 법: <strong style="color:#0f172a;">비중%</strong>
    <span style="background:#dcfce7; color:#15803d; padding:1px 5px; border-radius:3px; font-size:9px; font-weight:700; margin:0 2px;">▲N.N%p</span>
    <span style="background:#fee2e2; color:#b91c1c; padding:1px 5px; border-radius:3px; font-size:9px; font-weight:700; margin-right:4px;">▼N.N%p</span>
    <span style="color:#475569;">비중 변화 ({rank_prev_label} 대비, %p)</span>
    · <strong style="color:#0f172a;">매출액</strong>
    <span style="color:#15803d; font-weight:700; font-size:11px; margin:0 2px;">▲N%</span>
    <span style="color:#b91c1c; font-weight:700; font-size:11px; margin-right:4px;">▼N%</span>
    <span style="color:#475569;">매출 변화 ({rank_prev_label} 대비, %)</span>
  </div>
  {cat_html}
</div>
